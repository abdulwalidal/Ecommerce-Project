...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProduct(
        ...
        ProductResponse productResponse = productService.getAll(pageNumber,pageSize,sortBy, orderBy);
...
// while ProductResponse is used to wrap a list of products.
    ...
    public ResponseEntity<ProductResponse> getProductByKeyword(@PathVariable  String keyword,
        ...
        ProductResponse productResponse = productService.searchByKeyword(keyword, pageNumber, pageSize, sortBy,orderBy);
        return new ResponseEntity<>(productResponse, HttpStatus.OK);
    }

    @PutMapping("admin/{productId}/products")
    ...
    @DeleteMapping("/admin/{productId}/product")
